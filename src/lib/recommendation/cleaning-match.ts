...
const SURFACE_WISH: [RegExp, CleaningSurface][] = [
  ...
  /*
    기기 이름 자체가 무엇을 닦는지 말해 준다. "흡입 전용 로봇청소기
    교체"라고만 적으면 바닥이라는 말이 없어 대상을 못 읽었고, 그 틈으로
    유리창 청소 로봇이 통과했다. 이 기기들은 모두 바닥을 닦는 것이다.
  */
  [/로봇청소기|무선청소기|물걸레청소기|스팀청소기|진공청소기|스틱청소기/, "floor"],
];
